...
if args.tar:
    ...
    command = 'tar --exclude="{0}" -zcf {1} -C {2} {3}'.format(excludePath, tarLFN, cmsswWorkDir, cmssw_version)
...
baseEOSout            = 'root://cmseos.fnal.gov//store/user/lcadamur/EMTF_ntuples/%s' % tag
...
EOSfilelistProto       = baseEOSout + '/filelist/' + outListNameBareProto
